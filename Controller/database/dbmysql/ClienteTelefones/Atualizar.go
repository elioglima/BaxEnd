...
func (s *ClienteTelefonesST) Atualizar(ArrayByteIn []byte) (string, error) {
...
func (s *ClienteTelefonesST) ValidacaoAlterar(dados *ClienteTelefoneDadosInST) (string, error) {
