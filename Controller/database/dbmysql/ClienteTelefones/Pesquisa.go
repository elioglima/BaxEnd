...
/*
	CLASSE DE CADASTRO DE ClienteS
...
func (s *ClienteTelefonesST) PesquisaTodos(ArrayByteIn []byte) error {
	type CDados struct {
	}
...
func (s *ClienteTelefonesST) PesquisaCodigo(ID int64) error {
...
func (s *ClienteTelefonesST) PesquisaWhere(WhereIn string) error {
...
func (s *ClienteTelefonesST) PesquisaArrayByteIn(ArrayByteIn []byte) error {
