...
/* **********************************************************************
	STRUCT ClienteTipoEnderecoDadosInST
	Classe de Entrada e alterações de dados da Cliente e filiais

** ********************************************************************** */

type ClienteTipoEnderecoDadosInST struct {
	Id             *int64
	EmpresaID      *int64
	ClienteID      *int64
	Email          *string
...
func NewClienteTipoEnderecoDadosInST(dbConexao *GoMysql.ConexaoST) *ClienteTipoEnderecoDadosInST {
	s := new(ClienteTipoEnderecoDadosInST)
	s.dbConexao = dbConexao
	return s
}

func (s *ClienteTipoEnderecoDadosInST) Inserir() (sql.Result, error) {
...
func (s *ClienteTipoEnderecoDadosInST) Update() (sql.Result, error) {
...
func (s *ClienteTipoEnderecoDadosInST) Apagar() (sql.Result, error) {
