...
/* **********************************************************************
	STRUCT ClienteEmailDadosInST
	Classe de Entrada e alterações de dados da Cliente e filiais

** ********************************************************************** */

type ClienteEmailDadosInST struct {
	Id             *int64
	EmpresaID      *int64
	ClienteID      *int64
	Email          *string
...
func NewClienteEmailDadosInST(dbConexao *GoMysql.ConexaoST) *ClienteEmailDadosInST {
	s := new(ClienteEmailDadosInST)
	s.dbConexao = dbConexao
	return s
}

func (s *ClienteEmailDadosInST) Inserir() (sql.Result, error) {
...
func (s *ClienteEmailDadosInST) Update() (sql.Result, error) {
...
func (s *ClienteEmailDadosInST) Apagar() (sql.Result, error) {
