...
func (s *ClienteEnderecosST) PesquisaTodos(ArrayByteIn []byte) error {
	type CDados struct {
	}
...
func (s *ClienteEnderecosST) PesquisaCodigo(ID int64) error {
...
func (s *ClienteEnderecosST) PesquisaWhere(WhereIn string) error {
...
func (s *ClienteEnderecosST) PesquisaArrayByteIn(ArrayByteIn []byte) error {
