...
func NewClienteDadosInST(dbConexao *GoMysql.ConexaoST) *ClienteDadosInST {
	s := new(ClienteDadosInST)
	s.dbConexao = dbConexao
	return s
}

func (s *ClienteDadosInST) Inserir() (sql.Result, error) {
...
func (s *ClienteDadosInST) Update() (sql.Result, error) {
...
func (s *ClienteDadosInST) Apagar() (sql.Result, error) {
