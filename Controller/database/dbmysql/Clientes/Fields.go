...
func (s *ClienteST) MarshalResult(Results []map[string]interface{}) error {
	s.Field = ClienteDadosST{}
	s.Fields = []ClienteDadosST{}
...
func (s *ClienteST) MarshalResultToField(Results []map[string]interface{}) error {
	s.Field = ClienteDadosST{}
...
func (s *ClienteST) MarshalResultToFields(Results []map[string]interface{}) error {

	s.Fields = []ClienteDadosST{}
	for _, Result := range Results {
		FieldTemp := ClienteDadosST{}
