...
func (s *ClienteST) Atualizar(ArrayByteIn []byte) (string, error) {

	dados := NewClienteDadosInST(s.dbConexao)
...
func (s *ClienteST) ValidacaoAlterar(dados *ClienteDadosInST) (string, error) {
