...
func (s *ClienteST) PesquisaTodos(ArrayByteIn []byte) error {
	type CDados struct {
	}
...
func (s *ClienteST) PesquisaCodigo(ID int64) error {
...
func (s *ClienteST) PesquisaWhere(WhereIn string) error {
...
func (s *ClienteST) PesquisaArrayByteIn(ArrayByteIn []byte) error {
